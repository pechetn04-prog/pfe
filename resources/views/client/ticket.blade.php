        ...
        <div class="col-12">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                    <a href="{{ route('client.dashboard') }}" class="btn btn-white border shadow-sm rounded-pill p-2 d-flex align-items-center justify-content-center me-3" style="width: 45px; height: 45px;">
                        ...
                        <div class="col-lg-5 mb-3 mb-lg-0">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-white opacity-75 small">Un devis de {{ number_format($dossier->devis->montant_total, 3, ',', ' ') }} DT est prêt.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="d-flex flex-wrap justify-content-lg-end align-items-center gap-3">
                                {{-- Voir PDF --}}
                                <a href="{{ route('devis.pdf', $dossier->devis->id) }}" class="text-white text-decoration-none small fw-bold me-3" target="_blank">
                                    <i class="fas fa-file-pdf me-1"></i> Voir le détail
                                </a>

                                {{-- Bouton Accepter --}}
                                <form action="{{ route('client.devis.accepter', $dossier->id) }}" method="POST" class="m-0">
                                    @csrf
                                    <button type="submit" class="btn btn-success rounded-pill fw-bold px-4 py-2 shadow-sm border-2 border-white" onclick="return confirm('Voulez-vous accepter ce devis et lancer la réparation ?')">
                                        Accepter le Devis
                                    </button>
                                </form>

                                {{-- Bouton Refuser --}}
                                <form action="{{ route('client.devis.refuser', $dossier->id) }}" method="POST" class="m-0">
                                    @csrf
                                    <button type="submit" class="btn btn-danger rounded-pill fw-bold px-4 py-2 shadow-sm border-2 border-white" onclick="return confirm('Voulez-vous vraiment refuser ce devis ?')">
                                        Refuser le Devis
                                    </button>
                                </form>
                            </div>
                    ...
                    <div class="card border-0 shadow-sm mb-4 overflow-hidden" style="border-radius: 24px; background: white;">
                        ...
                        <div class="card-body p-4 pt-0">
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    <label class="small text-muted fw-bold text-uppercase mb-1 d-block">Symptôme(s) déclaré(s)</label>
                    ...
                    <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 24px; background: white;">
                        ...
                        <div class="card-body p-4 pt-0">
                            <div class="d-grid gap-3">
                                ...
                                {{-- Bon de Réception --}}
                                <a href="{{ route('dossiers.reception.pdf', $dossier->id) }}" class="btn btn-white border d-flex align-items-center justify-content-between p-3 rounded-4 transition-all" target="_blank">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <div class="text-muted" style="font-size: 0.7rem;">Document de prise en charge</div>
                                        </div>
                                    </div>
                                ...
                                <a href="{{ route('dossiers.diagnostic.pdf', $dossier->id) }}" class="btn btn-white border d-flex align-items-center justify-content-between p-3 rounded-4 transition-all" target="_blank">
                                    <div class="d-flex align-items-center">
                                        <div class="bg-soft-warning text-warning rounded-3 p-2 me-3" style="background-color: #fffbeb; color: #d97706;">
                                            <i class="fas fa-microscope"></i>
                                        </div>
                                        <div class="text-start">
                                            <div class="fw-bold text-dark small">Rapport Diagnostic</div>
                                            <div class="text-muted" style="font-size: 0.7rem;">Détails de la panne</div>
                                        </div>
                                    </div>
                                    <i class="fas fa-download text-muted small"></i>
                                </a>
                                ...
                                {{-- Devis --}}
                                @if($dossier->devis)
                                <a href="{{ route('devis.pdf', $dossier->devis->id) }}" class="btn btn-white border d-flex align-items-center justify-content-between p-3 rounded-4 transition-all" target="_blank">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <div class="text-muted" style="font-size: 0.7rem;">Offre tarifaire</div>
                                        </div>
                                    </div>
                                    <i class="fas fa-download text-muted small"></i>
                                </a>
                                ...
                                {{-- Facture --}}
                                @if($dossier->facture)
                                <a href="{{ route('factures.pdf', $dossier->facture->id) }}" class="btn btn-white border d-flex align-items-center justify-content-between p-3 rounded-4 transition-all" target="_blank">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <div class="text-muted" style="font-size: 0.7rem;">Justificatif de paiement</div>
                                        </div>
                                    </div>
                                    <i class="fas fa-download text-muted small"></i>
                                </a>
