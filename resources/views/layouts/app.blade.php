...
<head>
    ...
    <style>
        ...
        .sidebar { width: 260px; min-height: 100vh; background-color: #1a2234; flex-shrink: 0; }
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2 p-0" style="width: 300px; border-radius: 12px; overflow: hidden;">
                            ...
                            <div style="max-height: 300px; overflow-y: auto;">
                                ...
                                <li class="px-3 py-2 border-bottom {{ $notification->read_at ? 'opacity-50' : 'bg-light' }}">
                                    <div class="small fw-bold text-dark">{{ $notification->data['title'] ?? 'Notification' }}</div>
