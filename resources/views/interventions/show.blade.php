...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('dossiers.intervention.pdf', $intervention->dossier_id) }}" target="_blank" class="btn btn-outline-danger shadow-sm">
                <i class="fas fa-file-pdf me-1"></i> Imprimer
            </a>
            <a href="{{ route('dossiers.show', $intervention->dossier_id) }}" class="btn btn-secondary">Retour au dossier</a>
        </div>
    </div>
                ...
                <div class="card-body p-4">
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="fw-bold">{{ \Carbon\Carbon::parse($intervention->date_intervention)->format('d/m/Y H:i') }}</div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="bg-light p-3 rounded border" style="white-space: pre-wrap;">{{ $intervention->rapport_technique ?? $intervention->compte_rendu }}</div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="rounded-3 overflow-hidden border" style="max-width: 400px;">
                            <img src="{{ asset('storage/' . $intervention->photo_intervention) }}" alt="Photo Intervention" class="img-fluid">
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="mb-0">
                        <label class="small text-muted fw-bold text-uppercase mb-2 d-block">Pièces Détachées Utilisées</label>
