            ...
            <div class="col-xl-6">
                <div class="card dash-card-table h-100">
                    <div class="card-header bg-white border-0 py-4 px-4 d-flex justify-content-between align-items-center">
                        ...
                        <span
                            class="badge bg-soft-warning text-warning rounded-pill px-3">{{ $dossiersDiagnostique->count() }}
                            à faire</span>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0 dash-table">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <td class="ps-4">
                                            ...
                                            <div class="extra-small text-muted">
                                                {{ $d->created_at ? $d->created_at->diffForHumans() : '—' }}</div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-end pe-4">
                                            <a href="{{ route('diagnostics.create', $d->id) }}"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center py-5 text-muted small fw-bold">Aucun diagnostic en
                                            attente.</td>
                                    </tr>
                                @endforelse
                            </tbody>
            ...
            <div class="col-xl-6">
                <div class="card dash-card-table h-100">
                    <div class="card-header bg-white border-0 py-4 px-4 d-flex justify-content-between align-items-center">
                        ...
                        <span
                            class="badge bg-soft-success text-success rounded-pill px-3">{{ $dossiersReparation->count() }}
                            à faire</span>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0 dash-table">
                            ...
                            <tbody>
                                @forelse($dossiersReparation as $d)
                                    <tr>
                                        ...
                                        <td class="text-end pe-4 d-flex justify-content-end gap-2">
                                            <a href="{{ route('interventions.create', $d->id) }}"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center py-5 text-muted small fw-bold">Aucune réparation en
                                            attente.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0 dash-table">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center py-5 text-muted small fw-bold">Aucune activité
                                            récente.</td>
                                    </tr>
                                @endforelse
                            </tbody>
