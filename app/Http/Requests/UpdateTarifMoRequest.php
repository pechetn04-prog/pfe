...
// Ce formulaire de requête valide la modification d'un tarif de main d'œuvre existant.
class UpdateTarifMoRequest extends FormRequest
{
    ...
    // Règles de validation pour la mise à jour d'un tarif de main d'œuvre.
